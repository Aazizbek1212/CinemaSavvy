...
***REMOVED***: str = config("***REMOVED***", default="django-insecure-6*8z(tqz5bjz$$g-yb1!=4upi7*g8rb8sm__1q9fki@b@fdg4c")
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": config("POSTGRES_PASSWORD", default="***REMOVED***"),
...
AWS_ACCESS_KEY_ID: str = config("MINIO_ACCESS_KEY", default="***REMOVED***")
AWS_SECRET_ACCESS_KEY: str = config("MINIO_***REMOVED***", default="***REMOVED***")
